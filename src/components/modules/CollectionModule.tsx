        ...
        {canEdit && (
          <div className="flex items-center gap-2 flex-wrap sm:flex-nowrap">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white text-xs font-semibold px-3 py-2 rounded-lg shadow-lg transition active:scale-95"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-rose-600 to-rose-500 hover:from-rose-500 hover:to-rose-400 text-white text-xs font-semibold px-3 py-2 rounded-lg shadow-lg transition active:scale-95"
            >
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-3 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1 bg-slate-950 p-1 rounded-lg border border-slate-800 self-start">
          <button
            ...
            className={`flex items-center gap-2 px-2.5 py-1.5 rounded-md text-xs font-semibold transition ${
      ...
      {activeTab === 'FIELD_ACTIONS' && (
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-lg">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-300">
              <thead className="bg-slate-950 text-slate-400 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-800">
                <tr>
                  <th className="py-2 px-3">No. Tindakan & Tanggal</th>
                  <th className="py-2 px-3">Kasus & Debitur</th>
                  <th className="py-2 px-3">Kategori Klien</th>
                  <th className="py-2 px-3">Petugas / Mitra</th>
                  <th className="py-2 px-3">Tindakan Lapangan</th>
                  <th className="py-2 px-3 text-right">Titipan Dana (Rp)</th>
                  <th className="py-2 px-3 text-center">Foto Bukti</th>
              ...
              <tbody className="divide-y divide-slate-800">
                {filteredCollections.length === 0 ? (
                  <tr>
                    <td colSpan={canEdit ? 9 : 8} className="py-6 text-center text-slate-500 text-xs">
                  ...
                  collectionPagination.pageItems.map((act) => {
                    ...
                    return (
                      <tr key={act.id} className="hover:bg-slate-800/40 transition">
                        ...
                        <td className="py-2.5 px-3 space-y-1 max-w-[200px]">
                          ...
                          <div className="text-[11px] text-slate-300 line-clamp-2 leading-normal">
                            {act.notes}
                          </div>
                        </td>
          ...
          <Pagination
            ...
            onPageSizeChange={collectionPagination.setPageSize}
          />
        </div>
      )}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-lg">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs text-slate-300">
              <thead className="bg-slate-950 text-slate-400 font-semibold uppercase text-[10px] tracking-wider border-b border-slate-800">
                <tr>
                  <th className="py-2 px-3">Waktu & Kanal</th>
                  <th className="py-2 px-3">Kasus & Debitur</th>
                  <th className="py-2 px-3">Kategori Klien</th>
                  <th className="py-2 px-3">PIC & Kontak</th>
                  <th className="py-2 px-3">Ringkasan Diskusi</th>
                  <th className="py-2 px-3">Hasil / Status</th>
                  <th className="py-2 px-3">Tindak Lanjut</th>
                  <th className="py-2 px-3 text-center">Lampiran & Foto</th>
                  {canEdit && <th className="py-2 px-3 text-right">Actions</th>}
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-800">
                    ...
                    return (
                      <tr key={log.id} className="hover:bg-slate-800/40 transition">
                        <td className="py-2.5 px-3 font-mono text-slate-400">
                          ...
                          <span className="bg-emerald-950 text-emerald-300 text-[9px] px-1.5 py-0.5 rounded border border-emerald-800 font-semibold mt-0.5 inline-flex items-center gap-1">
                        ...
                        <td className="py-2.5 px-3 text-slate-200 max-w-[260px] leading-normal">
                          {log.summary}
                        </td>
                        ...
                        <td className="py-2.5 px-3 text-slate-300 max-w-[180px]">
                          ...
                          <div className="flex items-center justify-center gap-2">
                            {photoCount > 0 && (
                              <button
                                ...
                                className="w-6 h-6 rounded border border-slate-700 overflow-hidden hover:border-amber-500 transition"
          ...
          <Pagination
            page={commPagination.page}
            totalPages={commPagination.totalPages}
            totalItems={commPagination.totalItems}
            pageSize={commPagination.pageSize}
            onPageChange={commPagination.setPage}
            onPageSizeChange={commPagination.setPageSize}
          />
        </div>
      )}
        ...
        <div className="space-y-2.5">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2.5">
            {filteredPhotos.length === 0 ? (
              <div className="col-span-full py-12 text-center text-slate-500 bg-slate-900 border border-slate-800 rounded-xl p-6">
                <Camera className="w-10 h-10 mx-auto text-slate-600 mb-1.5" />
                ...
                >
                  ...
                  <div className="p-2.5 space-y-1.5 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-slate-300 line-clamp-2 mt-0.5">{item.photo.caption}</p>
                    </div>
      ...
      {showUnifiedModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-3 overflow-y-auto">
          <form
            ...
            className="bg-slate-900 border border-slate-800 rounded-xl w-full max-w-3xl p-4 space-y-3 shadow-2xl my-8 max-h-[90vh] overflow-y-auto"
          >
            {/* Modal Header */}
            ...
            {selectedCase && (
              <div
                className={`p-3 rounded-xl border text-xs grid grid-cols-1 sm:grid-cols-3 gap-2 ${
                  isPerorangan
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                ...
                >
                  <PhoneCall className="w-3.5 h-3.5 text-blue-400 mt-0.5 shrink-0" />
                  <div>
                ...
                >
                  <Car className="w-3.5 h-3.5 text-rose-400 mt-0.5 shrink-0" />
                  <div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 leading-normal"
              />
            </div>

            {/* Repossession / Unit Execution Special Tier Parameters */}
            {interactionType === 'REPOSSESSION' && (
              <div className="bg-rose-950/20 border border-rose-800/60 rounded-xl p-3 space-y-2.5">
            ...
            <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800 space-y-2">
              ...
              {hasPayment && (
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1.5 border-t border-slate-800/80">
                  <div>
                    <label className="block text-[11px] text-slate-400 mb-0.5">
                  ...
                  <div>
                    <label className="block text-[11px] text-slate-400 mb-0.5">Metode Penerimaan</label>
                    <SearchableSelect 
                      value={paymentMethod}
                  ...
                  <div>
                    <label className="block text-[11px] text-slate-400 mb-0.5">No. Kwitansi / Tanda Terima</label>
                    <input
                      type="text"
                      value={receiptNo}
            ...
            <div className="bg-slate-950/60 p-3 rounded-xl border border-slate-800 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-amber-600/20 hover:bg-amber-600/30 text-amber-300 border border-amber-600/40 text-xs px-2.5 py-1.5 rounded-lg transition"
                >
              ...
              {uploadedPhotos.length > 0 ? (
                ...
                <div
                  onClick={() => fileInputRef.current?.click()}
                  className="border-2 border-dashed border-slate-800 hover:border-slate-700 rounded-lg p-3 text-center cursor-pointer transition"
                >
                  <Camera className="w-5 h-5 mx-auto text-slate-600 mb-0.5" />
            ...
            <div className="flex justify-end gap-2 pt-2 border-t border-slate-800">
              ...
              <button
                type="submit"
                className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold rounded-lg shadow-lg flex items-center gap-1.5 transition"
              >
      ...
      {selectedPhotoPreview && (
        <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-3">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-3xl w-full overflow-hidden shadow-2xl flex flex-col">
            ...
            <div className="bg-slate-950 flex items-center justify-center p-3 max-h-[60vh] overflow-hidden">
              <img
            ...
            <div className="p-3 bg-slate-900 border-t border-slate-800 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs">
              <div>
                <div className="flex items-center gap-2">
