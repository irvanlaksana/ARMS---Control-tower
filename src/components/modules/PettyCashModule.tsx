...
export const PettyCashModule: React.FC<PettyCashModuleProps> = ({
  ...
  }, [pettyCashList, typeFilter, categoryFilter, searchTerm]);

  const pettyCashPagination = usePagination<PettyCashTransaction>(filteredList, 10);
    ...
    <div className="space-y-4">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-lg">
          ...
          <table className="w-full text-left text-xs text-slate-300">
            ...
            <tbody className="divide-y divide-slate-800">
              {pettyCashPagination.pageItems.length === 0 ? (
                ...
                pettyCashPagination.pageItems.map((item) => {
        ...
        <Pagination
          ...
          totalItems={pettyCashPagination.totalItems}
