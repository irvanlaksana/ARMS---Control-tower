  ...
  return (
    <div className="space-y-4">
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-lg">
        ...
        <p className="text-sm text-slate-300 leading-normal mb-6">
        ...
        <div className="space-y-4 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-700 before:to-transparent">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-800 p-3 rounded-xl border border-slate-700 shadow-md">
              <h3 className="font-bold text-white text-sm mb-0.5">Onboarding & Penugasan Kasus</h3>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-slate-800 p-3 rounded-xl border border-slate-700 shadow-md">
              <h3 className="font-bold text-white text-sm mb-0.5">Eksekusi Lapangan & Pemantauan</h3>
              <ul className="text-xs text-slate-300 space-y-1 list-disc list-inside">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
            ...
            <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-emerald-950/40 p-3 rounded-xl border border-emerald-800/60 shadow-md">
              ...
              <div className="space-y-2">
                <div className="bg-slate-900/50 p-2.5 rounded-lg border border-slate-700/50">
                  <h4 className="text-xs font-bold text-white mb-0.5">1. Kalkulasi Final Invoice</h4>
                ...
                <div className="bg-slate-900/50 p-2.5 rounded-lg border border-slate-700/50">
                  <h4 className="text-xs font-bold text-white mb-0.5 flex items-center gap-1"><Edit className="w-3 h-3 text-amber-400"/> 2. Input Pembayaran</h4>
                  <p className="text-[11px] text-slate-300">
                ...
                <div className="bg-slate-900/50 p-2.5 rounded-lg border border-slate-700/50">
                  <h4 className="text-xs font-bold text-white mb-0.5 flex items-center gap-1"><Edit className="w-3 h-3 text-amber-400"/> 3. Manual Splitting Fee</h4>
                  <p className="text-[11px] text-slate-300 mb-1.5">Admin diwajibkan mengisi 3 kolom finansial internal secara manual sesuai kontrak Multi Finance:</p>
                ...
                <div className="bg-emerald-900/50 p-2.5 rounded-lg border border-emerald-700/50">
                  <h4 className="text-xs font-bold text-emerald-200 mb-0.5 flex items-center gap-1"><CheckCircle className="w-3 h-3 text-emerald-400"/> 4. State Akhir</h4>
