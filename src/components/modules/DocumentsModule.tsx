...
export const DocumentsModule: React.FC<DocumentsModuleProps> = ({ 
  ...
  return (
    <div className="space-y-4">
      {/* Header Banner */}
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-3.5 sm:p-4 shadow-xl flex flex-col md:flex-row items-start md:items-center justify-between gap-2.5">
        ...
        <div className="flex items-center flex-wrap gap-2.5 self-stretch sm:self-auto">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-xl transition shadow-lg shadow-blue-600/20 active:scale-95 flex-1 sm:flex-initial"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-3 py-2 bg-slate-800 hover:bg-slate-700 text-indigo-300 border border-indigo-700/60 text-xs font-semibold rounded-xl transition active:scale-95 flex-1 sm:flex-initial"
          >
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 pt-1 border-t border-slate-800/80">
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-2 text-xs text-slate-300 focus:outline-none focus:border-indigo-500"
                >
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs text-slate-300">
                <thead className="bg-slate-950 text-slate-400 font-semibold border-b border-slate-800">
                  <tr>
                    <th className="p-3">Dokumen & Nomor</th>
                    <th className="p-3">Kategori</th>
                    <th className="p-3">Subjek / Debitur / Klien</th>
                    <th className="p-3">Folder Target GDrive</th>
                    <th className="p-3">Link Google Drive</th>
                    <th className="p-3 text-center">Pratinjau Surat</th>
                        ...
                        <tr key={doc.id} className="hover:bg-slate-800/40 transition group">
                            ...
                            {hasDrive ? (
                              <div className="flex items-center gap-1.5">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noreferrer"
                                  className="inline-flex items-center gap-1.5 px-2 py-1 bg-blue-950 hover:bg-blue-900 text-blue-200 border border-blue-700/80 rounded-lg text-[11px] font-semibold transition group shadow-sm"
                                  title="Buka File di Google Drive (Tab Baru)"
                                >
                                  <HardDrive className="w-3 h-3 text-blue-400 group-hover:scale-110 transition-transform" />
                          ...
                          <td className="p-3 text-center">
                            <button
                              ...
                              className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-indigo-950 hover:bg-indigo-900 text-indigo-200 border border-indigo-800/80 rounded-lg text-[11px] font-semibold transition shadow-sm hover:scale-105 active:scale-95"
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-3.5 shadow-xl space-y-2.5">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 border-b border-slate-800 pb-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-lg transition shadow-md"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2.5">
              {(store.driveFolders || INITIAL_DRIVE_FOLDERS).map((folder) => {
                ...
                return (
                  <div
                    key={folder.id}
                    className="bg-slate-950 border border-slate-800 rounded-xl p-3 space-y-2 hover:border-slate-700 transition flex flex-col justify-between"
                  >
                    ...
                    <div className="pt-1.5 border-t border-slate-800/80 flex items-center justify-between gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 px-2.5 py-1.5 bg-indigo-950 hover:bg-indigo-900 text-indigo-200 border border-indigo-800 rounded-lg text-xs font-semibold transition"
                      >
      ...
      {showAddDocModal && (
        <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-sm flex items-center justify-center p-2.5 sm:p-3 overflow-y-auto">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-lg p-3.5 sm:p-4 space-y-2.5 shadow-2xl max-h-[85vh] overflow-y-auto my-auto">
            ...
            <form onSubmit={handleSaveNewDoc} className="space-y-2.5 text-xs">
              <div>
                <label className="block text-slate-300 font-semibold mb-0.5">Judul / Nama Dokumen *</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-2 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500"
                />
              </div>

              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-slate-300 font-semibold mb-0.5">Kategori Dokumen</label>
                  <select
                    value={newDocCategory}
                    onChange={(e) => setNewDocCategory(e.target.value as any)}
                    className="w-full bg-slate-950 border border-slate-800 rounded-xl px-2.5 py-2 text-white focus:outline-none focus:border-indigo-500"
                  >
                ...
                <div>
                  <label className="block text-slate-300 font-semibold mb-0.5">No. Kasus Terkait (Opsional)</label>
                  <input
                    type="text"
              ...
              <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-800">
                ...
                <button
                  type="submit"
                  className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition shadow-md flex items-center gap-1.5"
                >
