  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/85 backdrop-blur-sm flex items-center justify-center p-2.5 sm:p-3 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-3xl overflow-hidden shadow-2xl animate-fade-in my-auto max-h-[92vh] flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-rose-950/80 via-slate-900 to-slate-950 border-b border-slate-800 p-3.5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="p-2 bg-rose-900/60 border border-rose-700/60 rounded-xl text-rose-300 shadow-inner">
        ...
        <form onSubmit={handleSubmit} className="p-3.5 sm:p-4 space-y-3 overflow-y-auto flex-1">
          ...
          <div className="space-y-1.5">
            ...
            {targetCase && (
              <div className="bg-slate-950/70 border border-slate-800/80 rounded-lg p-2.5 grid grid-cols-1 sm:grid-cols-3 gap-2 text-xs">
                <div>
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-3 space-y-2.5">
            <h4 className="text-xs font-bold text-slate-200 flex items-center justify-between border-b border-slate-800/80 pb-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
              <div>
                <label className="block text-[11px] text-slate-400 mb-0.5">Kategori Kendaraan</label>
                <select
                  value={vehicleType}
              ...
              <div>
                <label className="block text-[11px] text-slate-400 mb-0.5">Tahun Pembuatan Unit</label>
                <input
                  type="number"
                  min="2000"
              ...
              <div>
                <label className="block text-[11px] text-slate-400 mb-0.5">Kondisi Fisik Unit</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 pt-1">
              <label className="flex items-center gap-2 p-2 bg-slate-900 border border-slate-800 rounded-lg cursor-pointer hover:bg-slate-850 transition">
                <input
                  type="checkbox"
                  checked={hasStnk}
                  onChange={(e) => setHasStnk(e.target.checked)}
                  className="w-3.5 h-3.5 rounded text-indigo-600 bg-slate-950 border-slate-800 focus:ring-0"
                />
          ...
          <div className="bg-slate-950/80 border border-slate-800 rounded-xl p-3 space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              ...
              <div className="p-2.5 bg-slate-900 border border-slate-800 rounded-lg flex items-center justify-between">
                ...
                {calcResult.isMitraDC ? (
                  <span className="px-2 py-1 bg-amber-950/80 text-amber-300 border border-amber-800 text-[10px] font-bold rounded-lg flex items-center gap-1">
                    ⚡ MITRA DC (Split Commission)
                  </span>
                ) : (
                  <span className="px-2 py-1 bg-blue-950/80 text-blue-300 border border-blue-800 text-[10px] font-bold rounded-lg flex items-center gap-1">
            ...
            {calcResult.isMitraDC && (
              <div className="p-2.5 bg-amber-950/40 border border-amber-800/60 rounded-lg text-xs text-amber-200 space-y-1.5">
          ...
          <div className="bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950/50 border-2 border-emerald-600/70 rounded-2xl p-3.5 space-y-2.5 shadow-xl">
            <div className="flex items-center justify-between border-b border-slate-800 pb-2">
              ...
              <span className="px-2 py-0.5 bg-emerald-950 border border-emerald-800 text-emerald-300 text-[10px] font-bold font-mono rounded-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 text-xs">
              ...
              <div className="bg-slate-950/70 p-2.5 rounded-xl border border-indigo-900/60 space-y-1">
            ...
            {calcResult.modifiers.length > 0 && (
              <div className="bg-slate-950/60 p-2.5 rounded-lg border border-slate-800/80 text-xs space-y-1.5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2 text-xs text-white font-mono focus:border-rose-500 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-lg p-2 text-xs text-white focus:border-rose-500 focus:outline-none"
              />
            </div>
          ...
          <div className="flex items-center justify-between pt-3 border-t border-slate-800 gap-2">
            ...
            <button
              type="submit"
              className="flex items-center gap-2 px-4 py-2 bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold rounded-lg shadow-lg shadow-rose-950/50 transition cursor-pointer"
            >
